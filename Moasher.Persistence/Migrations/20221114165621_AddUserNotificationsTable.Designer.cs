...
namespace Moasher.Persistence.Migrations
{
    ...
    [Migration("20221114165621_AddUserNotificationsTable")]
            ...
            modelBuilder.Entity("Moasher.Domain.Entities.Entity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1751ef7f-0509-4279-895f-c4b37faa61a9"),
                            Code = "VRO",
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 11, 14, 19, 56, 20, 909, DateTimeKind.Unspecified).AddTicks(1562), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "System",
                            IsOrganizer = true,
            ...
            modelBuilder.Entity("Moasher.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e255424f-ff9f-4009-a4e8-43bd7e4b27bc"),
                            ConcurrencyStamp = "184d8614-3202-405c-b1aa-5adc16893ba2",
                        ...
                        new
                        {
                            Id = new Guid("532c5888-cf2c-4188-9040-3e92f19ab746"),
                            ConcurrencyStamp = "bacf8382-a359-4eef-9376-ffaec56a4786",
                            LocalizedName = "مشرف",
                            Name = "Admin",
                        ...
                        new
                        {
                            Id = new Guid("a2989de7-4b60-4f79-ad9c-e9f13ac8edf1"),
                            ConcurrencyStamp = "8860b05f-a4e2-436d-9881-3ac7f7e91381",
                        ...
                        new
                        {
                            Id = new Guid("bce5a508-1286-4b9a-8dc7-7599e4ef1d6c"),
                            ConcurrencyStamp = "5c006810-2e9b-406d-a92a-ec8ec8acdf61",
                        ...
                        new
                        {
                            Id = new Guid("2f416076-22bd-4cd1-9792-5614d7aca55a"),
                            ConcurrencyStamp = "33e2c954-420c-4400-af8e-4a816b863780",
                        ...
                        new
                        {
                            Id = new Guid("7521b9fa-d5eb-4008-9a4d-08a80ce515de"),
                            ConcurrencyStamp = "9547808e-8458-451a-ba0d-b5777a8098cc",
                        ...
                        new
                        {
                            Id = new Guid("92394268-d891-47b4-99ff-1b16e20d7a5d"),
                            ConcurrencyStamp = "0c5dfe54-f37d-4768-a633-7dbb38bb06cc",
                        ...
                        new
                        {
                            Id = new Guid("3f528140-2757-4294-8929-a75a5044bb90"),
                            ConcurrencyStamp = "a56a5415-70fa-4ec9-9ca3-4bd96353372f",
