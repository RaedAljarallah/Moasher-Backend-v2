...
namespace Moasher.Persistence.Migrations
{
    ...
    [Migration("20221109172239_AddEditRequestsUpdatedTable")]
    partial class AddEditRequestsUpdatedTable
    {
            ...
            modelBuilder.Entity("Moasher.Domain.Entities.Entity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b7a28afb-e901-40cc-b10d-8370f40ff881"),
                            Code = "VRO",
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 11, 9, 20, 22, 39, 573, DateTimeKind.Unspecified).AddTicks(7433), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "System",
                            IsOrganizer = true,
            ...
            modelBuilder.Entity("Moasher.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("96db5d54-f9b9-47fc-90c8-e359a316f79f"),
                            ConcurrencyStamp = "b444f1cb-f8a2-4a1f-96b5-db3d541f602f",
                        ...
                        new
                        {
                            Id = new Guid("58e01560-9f42-4624-a876-e2ae4d5fb262"),
                            ConcurrencyStamp = "1f6466a1-9165-4c84-9236-401836859036",
                            LocalizedName = "مشرف",
                            Name = "Admin",
                        ...
                        new
                        {
                            Id = new Guid("d6be389e-89ad-49d0-ba5a-aecc7f4a985e"),
                            ConcurrencyStamp = "51d08742-5fc6-45d9-9f0b-b613eec472a2",
                        ...
                        new
                        {
                            Id = new Guid("ad8b086c-a26c-4cc7-9b2a-6f9c9037c244"),
                            ConcurrencyStamp = "8f1cc223-e9be-4ba8-adc5-d0fb60f51bce",
                        ...
                        new
                        {
                            Id = new Guid("534d96e3-b227-4122-be54-a56b948f35f3"),
                            ConcurrencyStamp = "78d1b754-f03d-4eda-8ba1-7689894ed547",
                        ...
                        new
                        {
                            Id = new Guid("3fd927fe-2efa-4ddf-a07b-db57831aba81"),
                            ConcurrencyStamp = "fd6770ce-5eca-46da-b38a-0f420a85b1db",
                        ...
                        new
                        {
                            Id = new Guid("de471d86-9a93-4538-8f4e-dea89459cd10"),
                            ConcurrencyStamp = "2542493e-5172-49d6-ab7d-329029e1c60c",
                        ...
                        new
                        {
                            Id = new Guid("ceebbd8e-f57f-4475-8fe9-5feb7b364b6c"),
                            ConcurrencyStamp = "ff497f34-187a-4eea-beb4-dcbbb2cc571e",
