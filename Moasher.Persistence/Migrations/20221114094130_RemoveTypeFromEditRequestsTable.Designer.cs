...
namespace Moasher.Persistence.Migrations
{
    ...
    [Migration("20221114094130_RemoveTypeFromEditRequestsTable")]
    partial class RemoveTypeFromEditRequestsTable
    {
            ...
            modelBuilder.Entity("Moasher.Domain.Entities.Entity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7c2b77c1-f3a8-4287-8dce-7ccc1205ae7d"),
                            Code = "VRO",
                            CreatedAt = new DateTimeOffset(new DateTime(2022, 11, 14, 12, 41, 30, 189, DateTimeKind.Unspecified).AddTicks(1982), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = "System",
                            IsOrganizer = true,
            ...
            modelBuilder.Entity("Moasher.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d957d3d9-f2d5-4ccf-a44e-768cdd2a5a42"),
                            ConcurrencyStamp = "114a62fd-b28d-4100-b4e0-594d9a703f8f",
                        ...
                        new
                        {
                            Id = new Guid("cabd857c-6a48-420c-99c3-5ea978225e9a"),
                            ConcurrencyStamp = "55ee8aa1-42fb-46a5-b63d-6702fc68017a",
                            LocalizedName = "مشرف",
                            Name = "Admin",
                        ...
                        new
                        {
                            Id = new Guid("3e3f05d3-89e8-447f-996e-ec2792a882c3"),
                            ConcurrencyStamp = "55fc6d28-7d68-4327-bc48-74ac86dc4e05",
                        ...
                        new
                        {
                            Id = new Guid("95899227-394e-45cc-9b5b-1aec7ccac2bc"),
                            ConcurrencyStamp = "87e90b32-f976-4d5a-a4ef-eeabf593a128",
                        ...
                        new
                        {
                            Id = new Guid("c09c674c-68e1-428c-9bda-99163a1484bd"),
                            ConcurrencyStamp = "ef0f55b3-99b0-43b2-a93f-0d38458e7d76",
                        ...
                        new
                        {
                            Id = new Guid("e754fe60-4af4-480b-81c1-b88444cf8f59"),
                            ConcurrencyStamp = "3a92edab-8b4e-48a6-af03-94032acd545c",
                        ...
                        new
                        {
                            Id = new Guid("a960dd8a-feb5-4293-b79e-c5f653d82d33"),
                            ConcurrencyStamp = "891df8ef-ffc8-423a-b1d8-8f1dfa1b2930",
                        ...
                        new
                        {
                            Id = new Guid("176ac532-8be1-4576-99af-9da18deb5bdd"),
                            ConcurrencyStamp = "d61fde1d-091e-44ab-8b7d-39689486883c",
