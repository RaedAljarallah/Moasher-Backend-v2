...
public class KPIValueDeletedEventHandler : INotificationHandler<KPIValueDeletedEvent>
{
    private readonly IMoasherDbContext _context;

    public KPIValueDeletedEventHandler(IMoasherDbContext context)
    {
        _context = context;
    }
    
    public async Task Handle(KPIValueDeletedEvent notification, CancellationToken cancellationToken)
    {
